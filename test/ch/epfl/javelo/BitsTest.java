...
public class BitsTest {
    ...
    void extractSignedWorkOnData() {
        ...
        /*assertEquals(expectedData1,Bits.extractSigned(initialData,8,4));*/
    ...
    void extractUnsignedWorkOnData() {
        int initialData = 0b11001010111111101011101010111110;
        int exeptedData1 = 0b10101011111000000000000000000000;
        int expectedData2 = 0b00000000000000000000000000001010;
        /*assertEquals(exeptedData1,Bits.extractUnsigned(initialData,8,4))*/
