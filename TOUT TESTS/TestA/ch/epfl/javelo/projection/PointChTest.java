...
class PointChTest {
    ...
    @Test
    void pointChConstructorThrowsOnInvalidCoordinatesA() {
    ...
    @Test
    void pointChConstructorWorksOnValidCoordinatesA() {
        var rng = newRandom();
    ...
    @Test
    void pointChSquaredDistanceToWorksOnKnownValuesA() {
    ...
    @Test
    void pointChDistanceToWorksOnKnownValuesA() {
        var actual1 = new PointCh(2600000, 1200000)
    ...
    @Test
    void pointChLonWorksWithKnownValuesA() {
    ...
    @Test
    void pointChLatWorksWithKnownValuesA() {
