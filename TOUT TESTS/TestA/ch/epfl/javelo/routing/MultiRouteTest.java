...
public class MultiRouteTest {
    ...
    void elevationAt(){
        ...
        edges2.add(new Edge(1, 2, new PointCh(2800040, 1205000), new PointCh(2800120, 1205000), 80, Functions.sampled(tab2, 80)));
        ...
        MultiRoute multiRoute3 = new MultiRoute(multiRouteList3);

        List<Route> multiRouteList12 = new ArrayList<>();
        multiRouteList12.add(multiRoute1);
        multiRouteList12.add(multiRoute2);
        MultiRoute multiRoute12 = new MultiRoute(multiRouteList12);
        List<Route> multiR12_3 = new ArrayList<>();
        multiR12_3.add(multiRoute12);
        multiR12_3.add(multiRoute3);
        MultiRoute singleRoute = new MultiRoute(multiR12_3);
    ...
    void pointAtWorkProperly(){
        ...
        List<Edge> edges2 = new ArrayList<>();
        List<Edge> edges3 = new ArrayList<>();
        edges1.add(new Edge(0, 1, new PointCh(2500_000, 1200_000), new PointCh(2485_500, 1075_500), new PointCh(2500_000,1200_000).distanceTo( new PointCh(2485_500, 1075_500)), null));
        edges2.add(new Edge(1, 2,  new PointCh(2485_500, 1075_500), new PointCh(2600_000,1075_500), new PointCh(2600_000,1075_500).distanceTo( new PointCh(2485_500, 1075_500)), null));
        edges3.add(new Edge(2, 3,  new PointCh(2600_000,1075_500), new PointCh(2830_000, 1290_000), new PointCh(2600_000,1075_500).distanceTo( new PointCh(2830_000, 1290_000)), null));
    ...
    @Test
    void indexOfSegmentAtworkProperly(){

        List<Edge> edges1 = new ArrayList<>();
        List<Edge> edges2 = new ArrayList<>();
        List<Edge> edges3 = new ArrayList<>();

        edges1.add(new Edge(0, 1, null, null, 12.56, null));
        edges1.add(new Edge(0, 1, null, null, 1.23, null));
        edges1.add(new Edge(0, 1, null, null, 8.394, null));
        //21
        edges2.add(new Edge(0, 1, null, null, 371, null));
        edges2.add(new Edge(0, 1, null, null, 31.23, null));
        //425
        edges3.add(new Edge(0, 1, null, null, 71, null));
        edges3.add(new Edge(0, 1, null, null, 8.123, null));
        ...
        assertEquals((double) 0, singleRoute.indexOfSegmentAt(-210));
        assertEquals((double) 0, singleRoute.indexOfSegmentAt(20));
        assertEquals((double) 1, singleRoute.indexOfSegmentAt(35));
        assertEquals((double) 1, singleRoute.indexOfSegmentAt(115));
        assertEquals((double) 2, singleRoute.indexOfSegmentAt(599));
        assertEquals((double) 2, singleRoute.indexOfSegmentAt(230123));
    }
}