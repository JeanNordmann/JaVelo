...
class AttributeSetTest {
    ...
    @Test
    void constructorThrowsWhenInvalidBitsA(){
        assertThrows(IllegalArgumentException.class, () ->  {
    ...
    @Test
    void ofCreatesGoodAttributeSetOnNonTrivialAttributesA(){
    ...
    @Test
    void containsWorksOnNonTrivialValueA() {
    ...
    @Test
    void intersectsWorksOnNonTrivialValuesA(){
