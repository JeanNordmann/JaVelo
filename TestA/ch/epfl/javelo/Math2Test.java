...
class Math2Test {
    ...
    @Test
    void ceilDivThrowsOnNegativeXA() {
    ...
    @Test
    void ceilDivWorksOnPositiveValuesA() {
        var rng = newRandom();
    ...
    @Test
    void interpolateWorksWithRandomValuesA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
    ...
    @Test
    void clampIntClampsValueBelowMinA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
    ...
    @Test
    void clampIntClampsValueAboveMaxA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
            var min = rng.nextInt(-100_000, 100_000);
            var max = min + rng.nextInt(100_000);
    ...
    @Test
    void clampIntPreservesValuesBetweenMinAndMaxA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
            var min = rng.nextInt(-100_000, 100_000);
    ...
    @Test
    void clampDoubleClampsValueBelowMinA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
    ...
    @Test
    void clampDoubleClampsValueAboveMaxA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
            var min = rng.nextDouble(-100_000, 100_000);
            var max = min + rng.nextDouble(100_000);
    ...
    @Test
    void clampDoublePreservesValuesBetweenMinAndMaxA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
            var min = rng.nextDouble(-100_000, 100_000);
    ...
    @Test
    void dotProductOfAVectorWithItselfIsSquaredNormA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
    ...
    @Test
    void dotProductOfOrthogonalVectorsIsZeroA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
            var x = rng.nextDouble(-100, 100);
            var y = rng.nextDouble(-100, 100);
    ...
    @Test
    void squaredNormIsEqualToSquaredHypotA() {
        var rng = newRandom();
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
    ...
    @Test
    void projectionLengthWorksOnKnownValuesA() {
        var delta = 1e-7;
